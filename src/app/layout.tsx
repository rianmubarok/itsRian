...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body
        className={`${manrope.className} bg-primary-light dark:bg-primary-dark tracking-tight md:max-w-3xl lg:max-w-5xl mx-auto px-4 border-l border-r border-primary-gray/20`}
      >
