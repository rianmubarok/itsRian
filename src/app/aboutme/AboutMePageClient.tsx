...
export default function AboutMePageClient() {
  ...
  return (
    <main
      ...
      role="main"
    >
      <AnimatedSection direction="up" duration={700} delay={0}>
      ...
      <AnimatedSection direction="up" duration={700} delay={300}>
        <div className="tracking-normal font-regular text-base space-y-3 sm:space-y-4">
          <p>
            ...
            Firebase for creating scalable, real-time applications. I also enjoy
            learning about full-stack workflows and staying updated with modern
            development tools and best practices.
          </p>
          <p>
            What drives me most is creating intuitive user experiences that not
            only look good but also solve real problems. I pay close attention
            to accessibility, performance, and maintainable code — because great
