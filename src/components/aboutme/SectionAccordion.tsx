  ...
  return (
    <div className="border border-primary-gray/20 rounded-xl overflow-hidden bg-gray-50 dark:bg-primary-light/5">
      ...
      <button
        ...
        className="w-full px-6 py-4 text-left hover:bg-gray-100 dark:hover:bg-primary-light/10 transition-colors duration-200 flex items-center justify-between group cursor-pointer"
      >
